...
## -- How to Use
1. **Run:** Execute Main.java.
2. **Register:** Create a User (Customer/Provider/Manager).
3. **Setup:** Providers set their specialties (Manicure, Massage, etc.) and working hours.
4. **Book:** Customers can search for providers by specialty and book available slots.
